          ...
          <div className="col-md-12 text-center">
            <div className="form-heading">
              ...
              <p className="text-white" style={{ 'paddingBottom': '30' }}>
                Get your website free audit report within 24 hours &amp; find
                mistake <br /> that are holding your website to get rank.{" "}
                Fill the below form to get free website audit report.
              </p>
            </div>
          </div>
          <div className="col-md-12 text-center">
