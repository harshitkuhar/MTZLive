...
export default function Ormmobiletable() {
  return (
          ...
          >
            <div className="bs-pricing-item">
              <div className="bs-icon">
                <img src="images2/production.webp" alt="ORM Packages" />
              </div>
              <div className="head ">
                <div className="price-title">
                  <h2 className="text-uppercase">ORM Silver</h2>
                </div>
                <div className="price">
                  <h1>
                    <sup>$</sup>380<small>/mo</small>
                  </h1>
                </div>
              </div>
              <div
      ...
      <div className="col-md-12">
        <div className="bs-pricing-table-two text-center">
          ...
          >
            <div className="bs-pricing-item">
              <div className="bs-icon">
                <img src="images2/p-starter.webp" alt="ORM Packages" />
              </div>
              <div className="head ">
                <div className="price-title">
                  <h2 className="text-uppercase">ORM Gold</h2>
                </div>
                <div className="price">
                  <h1>
                    <sup>$</sup>680<small>/mo</small>
                  </h1>
                </div>
              </div>
              <div
      ...
      <div className="col-md-12">
        <div className="bs-pricing-table-two text-center">
          ...
          >
            <div className="bs-pricing-item">
              <div className="bs-icon">
                <img src="images2/p-booster.webp" alt="ORM Packages" />
              </div>
              <div className="head">
                <div className="price-title">
                  <h2 className="text-uppercase">ORM Platimun</h2>
                </div>
                <div className="price">
                  <h1>
                    <sup>$</sup>980<small>/mo</small>
                  </h1>
                </div>
              </div>
              <div
    ...
    <div className="row mt-70">
      <div className="col-md-12">
        <div className="bs-pricing-table-two text-center">
          <div
            className="packagepd"
            style={{ background: "#ffce1a", borderRadius: 5, marginBottom: 1 }}
          >
            <div className="bs-pricing-item">
              <div className="bs-icon">
                <img src="images2/p-speed.webp" alt="ORM Packages" />
              </div>
              <div className="head">
                <div className="price-title">
                  <h2 className="text-uppercase">ORM Diamond</h2>
                </div>
                <div className="price">
                  <h1>
                    <sup>$</sup>1280<small>/mo</small>
                  </h1>
                </div>
              </div>
              <div
